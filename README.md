...
Az egyszerűen kipróbálható kezdőoldal a `site` mappában található. Bármely modern böngészővel megnyitható, vagy egy minimális webszerverrel futtatható.
...
2. A repo **Settings → Pages** menüjében forrásnak állítsd be a `main` branchet és a `/site` mappát.
3. Mentés után pár perc múlva elérhető lesz az oldal a GitHub által generált URL-en.
